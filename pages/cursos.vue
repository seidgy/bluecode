<template>
    <ww-hero>
        <div class="hero__info">
            <p class="hero__brow">Transforme seu Futuro</p>
            <h1 class="hero__title">Capacitações em Empregabilidade, Empreendedorismo e Inovação com IA</h1>
        </div>
    </ww-hero>
        ...
        <div class="center">
            ...
            <div class="section-tabs-content">
                <div v-for="(t, i) in trilhas" :trilha="t">
                    <ww-grid-cursos :trilha="t" v-if="data.activeTrilha == i"></ww-grid-cursos>
                </div>
            </div>
        </div>
    </section>
    <section class="base-section beneficios" color="black">
        <div class="gradient">
